set xlabel "{Window Query Aspect [$\\frac{x}{y}$]}"
#set logscale x 2
#set logscale y 2
...
plot [][]\
  'stab_aspect.gp.dat' every ::1 using 1:($4/.016384) index 0 title "DCT-16K" ls 3, \
  'stab_aspect.gp.dat' every ::1 using 1:($4/.016384) index 1 title "RTREE-16K" ls 7, \
  'stab_aspect.gp.dat' every ::1 using 1:($3/.016384) index 0 title "DCT-4K" ls 2, \
  'stab_aspect.gp.dat' every ::1 using 1:($3/.016384) index 1 title "RTREE-4K" ls 6
